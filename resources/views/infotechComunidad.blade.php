...
<main class="main">
    ...
    <div class="row elementary justify-content-center" id="monthsTableContainer">
        <!-- tabla meses y años -->
    ...
    <div class="row elementary justify-content-center" id="monthsSelectContainer">
    <form id="formFilter" action="{{ route('filtro-buscar') }}" method="GET">
        <select id="selectMes" name="mes" class="months">
...
<button type="button" id="btnFiltrar" class="btn-filtrar">Filtrar</button> <!-- Botón de filtrar -->
