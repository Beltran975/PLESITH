...
>>>>>>> Stashed changes
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body collapse" id="informacionPLESITH">
                            ...
                            <form action="EnvioInformacion" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row form-outline md-4">
                                    ...
                                    <div class="col-md-8 mb-1">
                                        <input type="radio" name="pertenece" autocomplete="off" value="Sí" required>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <label class="form-label" for="evidenciaSni">Evidencia grado académico : </label>
                                </div>
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <select class="form-control" name="tipo" required>
                                            ...
                                            <option name="tipo" value="Artículos arbitrados y artículos indexados">Artículos arbitrados y artículos indexados</option>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <select class="form-control" name="proposito" required>
                                            ...
                                            <option name="proposito" value="Asimilación de tecnología">Asimilación de tecnología</option>
                                            ...
                                            <option name="proposito" value="Transferencia tecnológica">Transferencia tecnológica</option>
                                        </select>
                                    </div>
                                    <!-- Descripción -->
                                    <div class="col-md-4">
